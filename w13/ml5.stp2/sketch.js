...
function calcWidth(face) {
  ...
  let distance = dist(left.x, left.y, left.z, right.x, right.y, right.y);
  return distance;
}
...
//페이스메쉬를 통해서 얼굴의 정점 데이터를 갖고 있다. 그 중 세점을 추려 얼굴이 어느방향으로 향하는지 계산할 수 있는 함수를 작성해줘.
